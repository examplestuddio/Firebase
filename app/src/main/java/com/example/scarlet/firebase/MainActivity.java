...
public class MainActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        photoImage = findViewById(R.id.photoView);
...
//                });
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
           ...
           //     User user1 = new User(2,2,"bla-bla-bla");

          //  myRef.child("user").child("2").setValue(user1);
         //   }

        //    myRef.setValue(new User(001,4,"example.com"));
